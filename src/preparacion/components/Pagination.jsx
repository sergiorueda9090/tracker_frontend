...
import { handlePageChange, handlePageSizeChange } from '../../store/preparacionStore/preparacionThunks';
import '../../styles/Pagination.css';

const Pagination = () => {
  const dispatch = useDispatch();

  const { paginado_info } = useSelector(state => state.preparacionStore);
