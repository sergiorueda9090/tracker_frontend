...
import { handleFormStore, resetFormStore, loadForEditStore, 
        hanbleDataStore, setPaginationPage, setPaginationPageSize,
        setFilters, clearFilters, setFilterField } from "./userStore.js";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        await dispatch(hanbleDataStore({ users, paginado_info }));
