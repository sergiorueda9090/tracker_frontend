...
import { filterFieldThunk, applyFilters, handleClearFilters } from '../../store/clienteStore/clienteThunks';
import { getAllThunks as getAllDepartamentos } from '../../store/departamentosMunicipiosStore/departamentosMunicipiosThunks';
import '../../styles/Filter.css';

const Filter = () => {
  const dispatch = useDispatch();
  const { filters } = useSelector(state => state.clienteStore);
  const { departamentos } = useSelector(state => state.departamentosMunicipiosStore);
        ...
        <Grid container spacing={2.5}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              placeholder="Buscar por nombre, razón social, NIT, departamento o ciudad..."
            ...
            <Autocomplete
              ...
              value={
                departamentos
                  ...
                  .find(opt => opt.id == filters.departamento) || null
              }
              onChange={(event, newValue) => handleChange('departamento', newValue ? newValue.id : '')}
