...
import { handleFormStoreThunk, createThunks, updateThunks } from '../../store/archivadasStore/archivadasThunks';
...
const MainDialog = ({ open, onClose }) => {
  ...
  } = useSelector(state => state.archivadasStore);
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
      <DialogTitle sx={{ color: '#00A859', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: 1 }}>
        <Assignment /> {id ? 'Editar Trámite Archivado' : 'Registrar Nuevo Trámite Archivado'}
      </DialogTitle>
