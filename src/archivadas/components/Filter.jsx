...
import { filterFieldThunk, applyFilters, handleClearFilters } from '../../store/archivadasStore/archivadasThunks';
import '../../styles/Filter.css';

const Filter = () => {
  const dispatch = useDispatch();
  const { filters } = useSelector(state => state.archivadasStore);
  ...
  // Estados disponibles para Archivadas
    ...
    <Paper className="filter-paper">
      <Box className="filter-header">
        <Box display="flex" alignItems="center" gap={1}>
          ...
          <span className="filter-title">Filtros de Trámites Archivados</span>
        ...
        <Grid container spacing={2.5}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              placeholder="Buscar por placa, ID, usuario, código encargado..."
