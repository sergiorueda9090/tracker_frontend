...
import { handlePageChange, handlePageSizeChange } from '../../store/transitosTarifasStore/transitosTarifasThunks';
import '../../styles/Pagination.css';

const Pagination = () => {
  const dispatch = useDispatch();

  const { paginado_info } = useSelector(state => state.transitosTarifasStore);
